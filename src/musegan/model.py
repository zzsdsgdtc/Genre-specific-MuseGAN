...
class Model:
    ...
    def __call__(self, x=None, z=None, y=None, w=None, c=None, mode=None, params=None,
                 config=None):
        if mode == 'train':
            if x is None:
                raise TypeError("`x` must not be None for 'train' mode.")
            return self.get_train_nodes(x, z, y, w, c, params, config)
        elif mode == 'predict':
            if z is None:
    ...
    def get_train_nodes(self, x, z=None, y=None, w=None, c=None, params=None,
                        config=None):
...
#             nodes['gen_loss'], nodes['dis_loss'] = get_adv_losses(
#                 nodes['dis_real'], None, nodes['dis_fake'], config['gan_loss_type'])
