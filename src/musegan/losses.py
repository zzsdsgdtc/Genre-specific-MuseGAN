...
def get_adv_losses(discriminator_real_outputs, discriminator_real_wrong_outputs, discriminator_fake_outputs,
                   kind):
    ...
    return loss_fn(discriminator_real_outputs, discriminator_real_wrong_outputs, discriminator_fake_outputs)
...
def nonsaturating_gan_losses(discriminator_real_outputs,discriminator_real_wrong_outputs,
...
def wasserstein_gan_losses(discriminator_real_outputs, discriminator_real_wrong_outputs,
    ...
    discriminator_loss = (-generator_loss + tf.reduce_mean(
        discriminator_real_wrong_outputs)) / 2 - tf.reduce_mean(
