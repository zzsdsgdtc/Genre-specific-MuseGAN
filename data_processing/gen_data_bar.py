...
PATH_SEG = 'structure_rock/labs'
ROOT_TRACKS = '../../data_processing/lmd_matched_rock_track'
PATH_INSTRU_ACT = join(ROOT_TRACKS, 'act_instr')
PATH_SAVE_BAR = 'data_bar_rock'
PATH_SAVE_PHR = 'data_phr_rock'
TRA_SIZE = 500
VAL_SIZE = 0
SAMPLE_RATIO = 0.5

prefix = ['Bass', 'Drums', 'Guitar', 'Strings', 'Piano', 'instr_act']
PATH_SEG = 'structure_rock/labs'
        ...
        for pidx in range(1, tmp_phr_num-1):
            ...
            if(phr_len >=4): 
                ...
                for t in range(0, limit, 4):
                    parsed_phrase_list.append((st+t,st+t+4))
...
if __name__ == "__main__":
    ...
    with open('rnd_idx_list', 'w') as outfile:
        json.dump(out_list, outfile, default=default)